...
export const LINK_MAP: Readonly<Record<string, string>> = {
  AutomationRuntime: 'automation.md',
  AutomationRecord: 'automation.md',
  AutomationId: 'automation.md',
  AutomationTrigger: 'automation.md',
  AutomationTriggerInput: 'automation.md',
  AutomationAction: 'automation.md',
  AutomationRunSummary: 'automation.md',
  AutomationCreateInput: 'automation.md',
  AutomationModelSelection: 'automation.md',
  Memory: 'memory.md',
  MemoryEntry: 'memory.md',
  MemoryId: 'memory.md',
  MemoryKind: 'memory.md',
  MemoryProvider: 'memory.md',
  MemoryRecordInput: 'memory.md',
  Agent: 'core.md',
