...
| `dsh --profile mcp` | Serve the harness tools to MCP clients over stdio until disconnect. |
...
`config/examples/` ships opt-in overlays for GitHub review webhooks, session-local Schedule, persistent memory, browser automation, and documentation-lookup MCP servers, and runtime Cordis tools. They are never part of a default profile; the [user guides](../../docs/user/guide/index.md) and [developer practice guides](../../docs/user/develop/practice/index.md) own setup and safety instructions.
